            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
               ...
               {/* <nav className='flex items-center justify-between px-6 py-4 mb-5 bg-blue-700'> */}
                ...
                <Link
                  href="/signup"
                  className="ease-in-up hidden rounded-md bg-royalpurple py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Sign Up
                </Link> 
                   <div>  

...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-royalpurple bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-6 text-[#CED3F6] hover:text-royalpurple"
                  >
                    <svg
                      width="9"
                      height="18"
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Platform built by <a href="https://block21.xyz" rel="nofollow noopener">Block 21</a>
            </p>
          </div>
        </div>
